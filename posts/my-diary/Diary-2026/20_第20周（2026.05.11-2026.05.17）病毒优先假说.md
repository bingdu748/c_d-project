...
- Recently, I've seen a lot of news about 汉坦病毒 and 安第斯病毒, and it got me thinking about a hypothesis involving viruses.<br>For a long time, I believed evolution worked just as Darwin described: traits are passed down through 纵向基因遗传, and species change gradually over generations. But since the mid-20th century, biologists have found that this vertical path is not the whole story — 水平基因转移 lets genes jump directly between completely different organisms, especially in 微生物世界.<br>This is where the 病毒优先假说 comes in. The basic idea dates back to the mid-20th century, and evolutionary biologist Eugene V. Koonin and his colleagues have strongly advocated it since 2006. Its core premise is that viruses didn't just emerge alongside or after cells — they may have predated cellular life. In that view, early viruses were not merely 病原体 but key players in life's infancy: acting as tiny 基因载体, they shuttled genetic material between primitive organisms, helping to shape the very foundations of cellular life.<br>水平基因转移 is a real and powerful mechanism — it can transfer not just single genes but entire 功能模块, such as 代谢通路, 抗生素耐药性, and 致病岛, letting an organism gain a new capability far faster than waiting for 点突变 to accumulate. That said, it mostly moves existing genetic modules; complex traits that depend on many coordinated genes and 调控网络 are not something a single transfer can conjure up out of thin air.<br>As for 寒武纪生命大爆发, mainstream explanations center on other factors — rising oxygen levels, the evolution of developmental 基因调控网络, 生物矿化, and new 生态位. Viruses may well have influenced evolution on huge timescales, but directly tying 病毒优先假说 to that specific event goes beyond what it actually claims.<br>Still, the hypothesis adds a fascinating new layer to our understanding of evolution: viruses didn't just make us sick — they helped shape who we are today.
